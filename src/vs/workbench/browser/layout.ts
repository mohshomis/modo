...
export abstract class Layout extends Disposable implements IWorkbenchLayoutService {
	...
	private createGridDescriptor(): ISerializedGrid {
		...
		type StartupLayoutEventClassification = {
			...
			auxiliaryBarVisible: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'Whether or the not the Modo side bar is visible' };
...
const LayoutStateKeys = {
	...
	AUXILIARYBAR_SIZE: new InitializationStateKey<number>('auxiliaryBar.size', StorageScope.PROFILE, StorageTarget.MACHINE, 800), // Modo changed this from 200 to 800
...
class LayoutStateModel extends Disposable {
	...
	load(mainContainerDimension: IDimension): void {
		...
		LayoutStateKeys.AUXILIARYBAR_SIZE.defaultValue = Math.min(560, mainContainerDimension.width * 0.38);
